...
(function() {
  ...
  window.HandView = (function(_super) {
    ...
    HandView.prototype.template = _.template('<h2><% if(isDealer){ %>Dealer<% }else{ %>You<% } %> (<span class="score"></span>)<span><%= winState %></span></h2>');
    ...
    HandView.prototype.initialize = function() {
      ...
      this.collection.on('wins', (function(_this) {
        return function() {
          return _this.render();
        };
      })(this));
    ...
    HandView.prototype.startTurn = function() {};
